...
abstract class BaseCliente extends BaseObject  implements Persistent {
	...
	public function setCedula($v)
	{
		...
		if ($this->cedula !== $v) {
			$this->cedula = $v;
			$this->modifiedColumns[] = ClientePeer::CEDULA;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ClientePeer::CEDULA)) $criteria->add(ClientePeer::CEDULA, $this->cedula);
	 ...
	 * related Muestras from storage. If this Cliente is new, it will return
		...
		if ($this->collMuestras === null) {
			if ($this->isNew()) {
			   $this->collMuestras = array();
				...
				$criteria->add(MuestraPeer::CLIENTE_ID, $this->id);

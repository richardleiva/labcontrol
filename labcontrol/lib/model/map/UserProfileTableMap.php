...
class UserProfileTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.UserProfileTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('CARGO', 'Cargo', 'VARCHAR', false, 45, null);
    ...
    $this->addRelation('Muestra', 'Muestra', RelationMap::ONE_TO_MANY, array('id' => 'usuario_id', ), 'CASCADE', null);
	} // buildRelations()
